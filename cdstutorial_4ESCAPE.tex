...
(X-match \includegraphics[width=0.06
\textwidth]{../images/logo_xmatch_new.png} ) since November 2011.
...
\begin{figure}[H]
    ...
    \textwidth]{../images/cdsportal_object-information_ngc4039.png}
...
\begin{figure}[H]
    \center
    \includegraphics[width=1
    \textwidth]{../images/simbad_section_basic-data.png}
...
% this would be in 1923 ( 1923ApJ....57..137D )
\begin{figure}[H]
    \center
    \includegraphics[width=1
    \textwidth]{../images/simbad_section_references.png}
...
\center
\includegraphics[width=1
\textwidth]{../images/cdsportal_image-information_ngc4039.png}
\caption{Result of the query for NGC4039 in the CDS Portal}
...
\center
\includegraphics[width=1
\textwidth]{../images/cdsportal_catalogue-information_ngc4039.png}
\caption{Result of the query for NGC4039 in the CDS Portal}
...
% that would be 2 catalogues
Now go back to displaying all catalogues available within 0.2\,deg of NGC4039 by
clicking the
\includegraphics[width=0.06  \textwidth]{../images/cdsportal_show_all.png} button.
\item After selecting one catalogue, it is possible to look at it it (either
quickly \includegraphics[width=0.06  \textwidth]{../images/cdsportal_quickview.png}
or in \vizier\ \includegraphics[width=0.03 \textwidth]{../images/cdsportal_vizier.png}),
to plot column values \includegraphics[width=0.05 \textwidth]{../images/cdsportal_plot.png}
and to send it to \aladin\ (or other SAMP-aware tools like TOPCAT)
\includegraphics[width=0.03 \textwidth]{../images/cdsportal_samp.png}.
\begin{figure}[H]
\center
...
\includegraphics[width=0.03 \textwidth]{../images/cdsportal_info.png}, you'll
...
\subsection{How do the data get into the CDS databases?}
...
images in a number of different ways:
    ...
    also allows you to compute your own RGB colour images:
     \begin{itemize}
         ...
         \includegraphics[width=0.07 \textwidth]{../images/aladin_load_inview.png}.
...
%         the URL in the first column.
         ...
         "Chandra X-ray Observatory" in the \textbf{Select} line. There will be
         two services available, we will want to use the SIA service. Load the
         table "in view" from
         \textbf{Others} $\rightarrow$ \textbf{SIA (image)} $\rightarrow$
         \textbf{cxc.harvard.edu} $\rightarrow$
         \textbf{Chandra X-ray Observatory Data Archive} and select one of the
         observations with the longest "exptime".
         ...
         use for each colour component and click \textbf{CREATE}. If you want
         to adjust flux scale and transfer function of the individual images, use
         the \textbf{pixel} \includegraphics[width=0.04
         \textwidth]{../images/aladin_button_pixel.png} menu.
     \end{itemize}
...
\includegraphics[width=0.035\textwidth]{../images/aladin_button_grid.png}, zoom
out and use
the \textbf{pan} tool
...
\begin{figure}[H]
\center
\includegraphics[width=0.4 \textwidth]{../images/aladin_moc_intersection.png}
...
\textwidth]{../images/aladin_moc_filter-tab-by-moc.png}
...
\begin{figure}[H]
\center
\includegraphics[width=0.4 \textwidth]{../images/aladin_filter_mag.png}
